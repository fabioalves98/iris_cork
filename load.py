...
if __name__ == "__main__":
    ...
    try:
        ir = np.load(open("firstShots/depth-" + str(num) + ".npy", "r"))
        rgb = np.load(open("firstShots/rgb-" + str(num) + ".npy", "r"))
    ...
    # threshold_val = 180
    # ret,th = cv2.threshold(ir, 140, 255, 1)
    ...
    # cv2.drawContours(ir, contours, -1, (0,255,0), 1)
